...
{
    private static readonly Stack<List<IMemento>> sCompoundMementoStack = new();

    private static readonly Stack<IMemento> sUndoStack = new();
    private static readonly Stack<IMemento> sRedoStack = new();
