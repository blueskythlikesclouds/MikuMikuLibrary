...
public class GLMaterial : IDisposable
{
    ...
    public Matrix4x4 DiffuseTransformation { get; private set; }
    public Matrix4x4 AmbientTransformation { get; private set; }
    ...
    {
        DiffuseTransformation = Matrix4x4.Identity;
        AmbientTransformation = Matrix4x4.Identity;
        ...
        AmbientColor = new Vector4(0.25f, 0.25f, 0.25f, 1.0f);
        ...
        GLTexture GetTexture(MaterialTextureType type, uint offset)
        {
            ...
            foreach (var materialTexture in material.MaterialTextures)
            {
                ...
                {
                    if (offset == 0)
                        DiffuseTransformation = materialTexture.TextureCoordinateMatrix;

                    else if (offset == 1)
                        AmbientTransformation = materialTexture.TextureCoordinateMatrix;
                }
