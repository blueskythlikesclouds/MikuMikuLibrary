...
public partial class ConfigurationForm : Form
{
    ...
    private void SetConfiguration(Configuration configuration)
    {
        ...
        mBoneDataPathTextBox.Text = configuration?.BoneDataFilePath;
    ...
    private void OnSelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        mBoneDataPathTextBox.Enabled = enabled;
        ...
        mBoneDataBrowseButton.Enabled = enabled;
    ...
    private void OnBoneDataPathTextBoxTextChanged(object sender, EventArgs e)
    {
        SelectedConfiguration.BoneDataFilePath = mBoneDataPathTextBox.Text;
        SelectedConfiguration.BoneData = null;
    }
    ...
    private void OnBoneDataBrowse(object sender, EventArgs e)
    {
        mBoneDataPathTextBox.Text =
            ModuleImportUtilities.SelectModuleImport<BoneData>("Select a bone database file. (bone_data.bin/bone_data.bon)",
                SelectedConfiguration?.BoneDataFilePath) ?? mBoneDataPathTextBox.Text;
    }
    ...
    private void OnSearch(object sender, EventArgs e)
    {
        using (var folderBrowseDialog = new VistaFolderBrowserDialog())
        {
            ...
            if (string.IsNullOrEmpty(SelectedConfiguration.BoneDataFilePath))
            {
                SelectedConfiguration.BoneDataFilePath = PickPath("rom/bone_data.bin", "bone_data.bin", "data/bone_data.bon", "bone_data.bon");
            }
