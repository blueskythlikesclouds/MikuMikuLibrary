...
public class IBLNode : BinaryFileNode<IBL>
{
    ...
    [DisplayName("Diffuse coefficients")] public List<DiffuseCoefficient> DiffuseCoefficients => GetProperty<List<DiffuseCoefficient>>();

    [DisplayName("Light-maps")] public List<LightMap> LightMaps => GetProperty<List<LightMap>>();
