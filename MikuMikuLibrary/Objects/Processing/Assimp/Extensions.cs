...
namespace MikuMikuLibrary.Objects.Processing.Assimp
{
    public static class Extensions
    {
        ...
        {
            return new Ai.Vector2D( value.X, value.Y );
        }

        public static Ai.Vector3D ToAssimp( this Vector3 value )
        {
            return new Ai.Vector3D( value.X, value.Y, value.Z );
        }

        public static Ai.Matrix4x4 ToAssimp( this Matrix4x4 value )
        {
            return new Ai.Matrix4x4( value.M11, value.M12, value.M13, value.M14,
        ...
        {
            return new Ai.Matrix4x4( value.M11, value.M21, value.M31, value.M41,
        ...
        {
            return new Ai.Color4D( value.R, value.G, value.B, value.A );
        }
    }
}