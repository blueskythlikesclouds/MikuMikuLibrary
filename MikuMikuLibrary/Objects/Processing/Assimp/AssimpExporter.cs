...
public static class AssimpExporter
{
    ...
    private static Ai.Material CreateAiMaterialFromMaterial(Material material, TextureSet textureSet)
    {
        ...
        aiMaterial.Name = material.Name;
        aiMaterial.ColorDiffuse = material.Diffuse.ToAssimpColor();
        aiMaterial.ColorAmbient = material.Ambient.ToAssimpColor();
        aiMaterial.ColorSpecular = material.Ambient.ToAssimpColor();
        aiMaterial.ColorEmissive = material.Emission.ToAssimpColor();
