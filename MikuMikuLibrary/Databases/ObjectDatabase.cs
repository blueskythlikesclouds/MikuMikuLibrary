...
public class ObjectDatabase : BinaryFile
{
    ...
    public override void Write(EndianBinaryWriter writer, ISection section = null)
    {
        ...
        writer.WriteOffset(16, AlignmentMode.Left, () =>
        {
            ...
            {
                writer.WriteStringOffset(objectSetInfo.Name);
                writer.Write(objectSetInfo.Id);
                writer.WriteStringOffset(objectSetInfo.FileName);
                writer.WriteStringOffset(objectSetInfo.TextureFileName);
                writer.WriteStringOffset(objectSetInfo.ArchiveFileName);
        ...
        writer.WriteOffset(16, AlignmentMode.Left, () =>
        {
            ...
            foreach (var objectInfo in objectSetInfo.Objects)
            {
                ...
                writer.WriteStringOffset(objectInfo.Name);
            }
        });
    }
