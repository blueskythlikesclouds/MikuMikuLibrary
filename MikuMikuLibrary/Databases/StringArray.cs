    ...
    public override void Read(EndianBinaryReader reader, ISection section = null)
    {
        ...
        void ReadClassic()
        {
            ...
            if (stringOffset >= reader.Length)
            {
                ...
                stringOffset = BinaryPrimitives.ReverseEndianness(stringOffset);
            }
    ...
    public override void Write(EndianBinaryWriter writer, ISection section = null)
    {
        ...
        void WriteClassic()
        {
            ...
            foreach (var stringEntry in Strings.OrderBy(x => x.Id))
            {
                ...
                for (int i = 0; i < count; i++)
                    writer.WriteStringOffset(string.Empty);

                previousId = stringEntry.Id;

                writer.WriteStringOffset(stringEntry.Value);
            }
        ...
        void WriteModern()
        {
            ...
            writer.WriteOffset(64, AlignmentMode.Left, () =>
            {
