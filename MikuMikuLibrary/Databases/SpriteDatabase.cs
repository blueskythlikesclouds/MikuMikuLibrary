    ...
    public override void Write(EndianBinaryWriter writer, ISection section = null)
    {
        ...
        writer.WriteOffset(16, AlignmentMode.Left, () =>
        {
            for (int i = 0; i < SpriteSets.Count; i++)
            {
                ...
                writer.WriteStringOffset(spriteSetInfo.Name);
                writer.WriteStringOffset(spriteSetInfo.FileName);
                writer.Write(i);
            }
        });
        ...
        writer.WriteOffset(16, AlignmentMode.Left, () =>
        {
            for (int i = 0; i < SpriteSets.Count; i++)
            {
                ...
                foreach (var spriteInfo in spriteSetInfo.Sprites)
                {
                    ...
                    writer.WriteStringOffset(spriteInfo.Name);
                ...
                foreach (var spriteTextureInfo in spriteSetInfo.Textures)
                {
                    ...
                    writer.WriteStringOffset(spriteTextureInfo.Name);
