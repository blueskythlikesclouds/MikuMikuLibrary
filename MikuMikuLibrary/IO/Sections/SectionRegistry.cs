...
{
    private static readonly Dictionary<Type, SectionInfo> sSectionInfosBySectionType = new();

    private static readonly Dictionary<string, SectionInfo> sSectionInfosBySignature = new();

    private static readonly Dictionary<Type, SectionInfo> sSingleSectionInfosByDataType = new();
