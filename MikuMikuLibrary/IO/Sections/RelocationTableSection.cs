...
namespace MikuMikuLibrary.IO.Sections
{
    ...
    public class RelocationTableSection : Section<List<long>>
    {
        ...
        public RelocationTableSection( Stream source, List<long> dataToRead = null ) : base( source, dataToRead )
        {
        }

        public RelocationTableSection( List<long> dataToWrite ) : base( dataToWrite, Endianness.LittleEndian )
        {
        }
    }
}
