...
namespace MikuMikuLibrary.Chritm
{
    ...
    public class Item
    {
        public List<ItemObject> Objects { get; }
        public List<CmnitmAdjust> CmnitmAdjustSettings { get; }
        ...
        internal void Read(EndianBinaryReader reader)
        {
            ...
            reader.ReadAtOffset(CmnitmAdjustOffset, () =>
            {
                ...
                {
                    var Adjust = new CmnitmAdjust();
                    Adjust.Read(reader);
                    CmnitmAdjustSettings.Add(Adjust);
                }
            });
        ...
        internal void Write(EndianBinaryWriter writer)
        {
            ...
            writer.Write(CmnitmAdjustSettings.Count);
            writer.ScheduleWriteOffsetIf(CmnitmAdjustSettings.Count != 0, 4, AlignmentMode.Left, () =>
            {
                foreach (var Adjust in CmnitmAdjustSettings)
                {
                    Adjust.Write(writer);
                }
            });
        ...
        public Item()
        {
            ...
            CmnitmAdjustSettings = new List<CmnitmAdjust>();
