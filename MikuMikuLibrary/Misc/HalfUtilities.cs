namespace MikuMikuLibrary.Misc
{
    ...
    internal static class HalfUtilities
    {
        ...
        {
            uint result = sMantissaTable[ sOffsetTable[ half.Value >> 10 ] + ( half.Value & 0x3ff ) ] +
                          sExponentTable[ half.Value >> 10 ];
            return *( float* ) &result;
        }
        ...
        public static unsafe Half SingleToHalf( float single )
        {
            ...
            ushort result = ( ushort ) ( sBaseTable[ ( value >> 23 ) & 0x1ff ] +
                                         ( ( value & 0x007fffff ) >> sShiftTable[ value >> 23 ] ) );
