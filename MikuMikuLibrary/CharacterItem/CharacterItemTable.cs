...
public class CharacterItemTable : BinaryFile
{
    ...
    public override void Write(EndianBinaryWriter writer, ISection section = null)
    {
        ...
        writer.WriteOffsetIf(Items.Count != 0, 16, AlignmentMode.Left, () =>
        {
        ...
        writer.WriteOffsetIf(Costumes.Count != 0, 16, AlignmentMode.Left, () =>
        {
        ...
        writer.WriteOffsetIf(DebugSets.Count != 0, 16, AlignmentMode.Left, () =>
        {
