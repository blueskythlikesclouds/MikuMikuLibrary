...
public class CostumeItem
{
    ...
    internal void Write(EndianBinaryWriter writer)
    {
        ...
        writer.WriteOffsetIf(Objects.Count != 0, 4, AlignmentMode.Left, () =>
        {
        ...
        writer.WriteOffsetIf(CommonItemAdjustSettings.Count != 0, 4, AlignmentMode.Left, () =>
        {
        ...
        writer.WriteOffsetIf(TextureChangeSettings.Count != 0, 4, AlignmentMode.Left, () =>
        {
        ...
        writer.WriteOffsetIf(ObjectSetIDs.Count != 0, 4, AlignmentMode.Left, () =>
        {
